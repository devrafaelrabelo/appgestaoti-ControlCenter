...
INSERT INTO users (
  ...
  'a2000000-0000-0000-0000-000000000001', -- id
  'João',                                 -- first_name
  'Silva',                                -- last_name
  'João Silva',                           -- full_name
  NULL,                                   -- social_name
  'joaosilva',                            -- username
  'joao.silva@empresa.com',               -- email
  'joaosilva.personal@gmail.com',         -- personal_email
  '200.200.200-00',                       -- cpf
  '1993-07-15',                           -- birth_date
  true,                                   -- email_verified
  ...
  0,                                      -- login_attempts
  '192.168.0.50',                         -- last_password_change_ip
  ...
  'Belo Horizonte - MG',                  -- last_known_location
